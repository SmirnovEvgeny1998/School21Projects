...
2. Создайте скрипт *part2.sql*, в который, помимо описанного ниже, внесите тестовые запросы/вызовы для каждого пункта.
...
3. Создайте скрипт *part3.sql*, в который внесите описанные далее процедуры и функции.
...
| February | 35           |
| March    | 45           |
4. Для данной части задания вам нужно создать отдельную базу данных, 
...
## Срок выполнения
Отведено: 4 дня(28 часов).
Дополнительные задачи: все выполнены.
Выполнено за 8 дней.
## Тип проекта
Групповой(полученная позиция - бэкэнд). Имплементировал треть задач.
