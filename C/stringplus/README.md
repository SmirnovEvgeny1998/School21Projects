...
Необязательное задание на дополнительные баллы. Необходимо реализовать некоторые функции обработки строк из класса String:
...
## Срок выполнения
Отведено: 2 недели(112 часов).
Дополнительные задачи: все выполнены.
Выполнено за 9 дней.
## Тип проекта
Групповой(занятая позиция - тимлид). Отвечал за общее строение проекта, написал базовые функции sprintf и sscanf, а также половину оставшихся функций, имплиментаций флагов функций и юнит тестов для своих функций.
