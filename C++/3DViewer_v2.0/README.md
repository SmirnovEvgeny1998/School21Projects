...
Выполнено за 8 дней.
## Тип проекта
Групповой(занятая позиция - бэкэнд). Мною написаны настройки проекции, манипуляции 3д объектами(часть графического отображения), алгоритмы обработки, сохранение фотографий и гиф-изображение.
## Используемые языки/технологии/библиотеки.
С++, make, <gtest>(юнит-тесты), Qt.
