...
Выполнено за 2 дня.
## Тип проекта
Групповой(занятая позиция - тимлид). Отвечал за строение проекта, генерацию лабиринта, создание идеального лабиринта, загрузку и сохранение лабиринта из фаила.
